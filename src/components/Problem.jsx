  ...
  return (
    <div className="container px-5 py-24 mx-auto">
        ...
        <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
            ...
            <a className="mt-3 text-teal-400 inline-flex items-center">Learn More
        ...
        <button className="flex mx-auto mt-16 text-white bg-teal-500 border-0 py-2 px-8 focus:outline-none hover:bg-teal-600 rounded text-lg">Button</button>
    </div>
  )
}
